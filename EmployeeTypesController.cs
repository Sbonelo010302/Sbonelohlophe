...
namespace RailwayApp.Controllers
{
    public class EmployeeTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IsActive,CreatedDateTime,ModifiedDateTime,Name,Description,Key")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IsActive,CreatedDateTime,ModifiedDateTime,Name,Description,Key")] EmployeeType employeeType)
        {
            if (ModelState.IsValid)
            {
